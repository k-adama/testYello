...
class _Lecon56State extends State<Lecon56> {
  ...
  String audio0 = 'audio/lecon56/l56.mp3';
  String audio1 = 'audio/lecon56/justine.mp3';
  String audio2 = 'audio/lecon56/lejournal.mp3';
  String audio3 = 'audio/lecon56/justin.mp3';
  String audio4 = 'audio/lecon56/journal.mp3';
  String audio5 = 'audio/lecon56/ju.mp3';
  String audio6 = 'audio/lecon56/ju.mp3';
  String audio7 = 'audio/lecon56/ju.mp3';
  String audio8 = 'audio/lecon56/jo.mp3';
  String audio9 = 'audio/lecon56/j.mp3';
  String audio10 = 'audio/lecon56/j.mp3';
  ...
  void playSound(String thesound) {
    player.play(AssetSource('audio/lecon56/$thesound.mp3'));
  }
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(
                        height: 200,
                        child: Image(
                          image: AssetImage('assets/lecon56/l56.png'),
                          width: 300,
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              ...
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/j.mp3'));
                            },
                            child: Center(
                                child: Text('j',
                                    style: TextStyle(
                      ...
                      SizedBox(
                        ...
                        child: Card(
                          child: new InkWell(
                            ...
                            child: Center(
                                child: Image.asset("assets/lecon56/j1.png")),
                          ),
                        ),
                      ),
                    ],
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/ja.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/ja.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jo.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jo.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/ju.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/ju.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/ji.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/ji.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jou.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jou.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jon.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jon.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jai.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jai.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jem.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jem.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jin.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jin.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jom.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jom.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/joi.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/joi.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              ...
                              //print("tapped");
                              player
                                  .play(AssetSource('audio/lecon56/jeee.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child:
                                      Image.asset("assets/lecon56/jeee.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/jee.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/jee.png")),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Card(
                          child: new InkWell(
                            onTap: () {
                              // // Navigator.pushNamed(context, '/lecon1');
                              //print("tapped");
                              player.play(AssetSource('audio/lecon56/je.mp3'));
                            },
                            child: Center(
                              child: Center(
                                  child: Image.asset("assets/lecon56/je.png")),
                            ),
                          ),
                        ),
                      ),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: InkWell(
                    onTap: () {
                      extraHilght(8);
                      player.play(AssetSource('audio/lecon56/jupe.mp3'));
                    },
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('assets/lecon56/jupe.png'),
                          width: 250,
                          height: 200,
                        ),
                        SizedBox(
                ...
                SizedBox(
                  ...
                  child: InkWell(
                    onTap: () {
                      extraHilght(8);
                      player.play(AssetSource('audio/lecon56/jarre.mp3'));
                    },
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('assets/lecon56/jarre.png'),
                          width: 250,
                          height: 200,
                        ),
                        SizedBox(
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      extraHilght(9);
                      player.play(AssetSource('audio/lecon56/justinelong.mp3'));
                    },
